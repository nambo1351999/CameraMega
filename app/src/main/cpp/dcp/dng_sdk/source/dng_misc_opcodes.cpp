...
void dng_opcode_TrimBounds::Apply (dng_host & ,
								   dng_negative & ,
...
uint32 dng_opcode_MapTable::BufferPixelType (uint32 )
	{
...
void dng_opcode_MapTable::ProcessArea (dng_negative & ,
									   uint32 ,
...
uint32 dng_opcode_ScalePerRow::BufferPixelType (uint32 )
	{
...
uint32 dng_opcode_ScalePerColumn::BufferPixelType (uint32 )
	{
