...
void dng_preview::SetIFDInfo (dng_host & ,
...
dng_basic_tag_set * dng_preview::AddTagSet (dng_host & ,
...
dng_basic_tag_set * dng_jpeg_preview::AddTagSet (dng_host & ,
												 dng_tiff_directory &directory) const
	{
...
dng_basic_tag_set * dng_raw_preview::AddTagSet (dng_host & ,
												dng_tiff_directory &directory) const
	{
...
dng_basic_tag_set * dng_hdr_gain_map_preview::AddTagSet (dng_host & ,
														 dng_tiff_directory &directory) const
	{
...
dng_basic_tag_set * dng_mask_preview::AddTagSet (dng_host & ,
												 dng_tiff_directory &directory) const
	{
...
dng_basic_tag_set * dng_semantic_mask_preview::AddTagSet (dng_host & ,
														  dng_tiff_directory &directory) const
	{
...
dng_basic_tag_set * dng_depth_preview::AddTagSet (dng_host & ,
												  dng_tiff_directory &directory) const
	{
