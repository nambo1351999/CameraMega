...
void dng_opcode_FixBadPixelsConstant::Prepare (dng_negative & ,
											   uint32 ,
											   const dng_point & ,
											   const dng_rect & ,
											   uint32 imagePlanes,
...
void dng_opcode_FixBadPixelsConstant::ProcessArea (dng_negative & ,
												   uint32 ,
...
void dng_opcode_FixBadPixelsList::Prepare (dng_negative & ,
										   uint32 ,
										   const dng_point & ,
										   const dng_rect & ,
										   uint32 imagePlanes,
...
void dng_opcode_FixBadPixelsList::FixIsolatedPixel (dng_pixel_buffer &buffer,
	...
	if (IsGreen (badPoint.v, badPoint.h))		
		{
...
void dng_opcode_FixBadPixelsList::ProcessArea (dng_negative & ,
											   uint32 ,
											   dng_pixel_buffer &srcBuffer,
											   dng_pixel_buffer &dstBuffer,
											   const dng_rect &dstArea,
