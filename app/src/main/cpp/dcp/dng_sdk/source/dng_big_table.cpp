...
class dng_look_table_cache : public dng_big_table_cache
	...
	public:
		...
		virtual void InsertTableData (dng_lock_std_mutex & ,
									  const dng_big_table &table)
			{
		...
		virtual void EraseTableData (dng_lock_std_mutex & ,
									 const dng_fingerprint &fingerprint)
			{
		...
		virtual void ExtractTableData (dng_lock_std_mutex & ,
									   const dng_fingerprint &fingerprint,
									   dng_big_table &table)
			{
...
class dng_image_table_cache : public dng_big_table_cache
	...
	public:
		...
		void InsertTableData (dng_lock_std_mutex & ,
		...
		void EraseTableData (dng_lock_std_mutex & ,
		...
		void ExtractTableData (dng_lock_std_mutex & ,
							   const dng_fingerprint &fingerprint,
...
bool dng_big_table_storage::ReadTable (dng_big_table & ,
									   const dng_fingerprint & ,
...
void dng_big_table_storage::MissingTable (const dng_fingerprint & )
	{
	
	}

bool dng_big_table_storage::GroupToInstance (const dng_fingerprint & ,
...
void dng_masked_rgb_table::GetStream (dng_host &host,
	...
	nameData.Buffer_uint8 () [nameLen] = 0;	 
	...
	if (fPixelType == 0)					 
		...
		constexpr uint16 scale8to16 = 257; 
