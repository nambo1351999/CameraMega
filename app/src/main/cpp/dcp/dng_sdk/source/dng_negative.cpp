...
void dng_semantic_mask::CalcMaskSubArea (dng_point &origin,
	...
	origin.v = (int32) fMaskSubArea [0];	 
	origin.h = (int32) fMaskSubArea [1];	 

	wholeImageArea.t = (int32) 0;
	wholeImageArea.l = (int32) 0;
	wholeImageArea.b = (int32) fMaskSubArea [3]; 
	wholeImageArea.r = (int32) fMaskSubArea [2]; 
...
void dng_negative::DoPostOpcodeList2 (dng_host & )
	{
...
void dng_negative::DefloatStage2 (dng_host & )
	{
...
void dng_encode_proxy_task::Process (uint32 ,
									 const dng_rect &tile,
									 dng_abort_sniffer * )
	{
...
bool dng_negative::SupportsPreservedBlackLevels (dng_host & )
	{
...
void dng_negative::AdjustGainMapForStage3 (dng_host & )
	{
...
bool dng_negative::NeedFlattenTransparency (dng_host & )
	{
...
void dng_negative::FlattenTransparency (dng_host & )
	{
