...
int dng_pthread_create(dng_pthread_t *thread, const dng_pthread_attr_t * , void * (*func)(void *), void *arg);
...
int dng_pthread_mutexattr_settype(dng_pthread_mutexattr_t *mutexattr, int );

int dng_pthread_mutex_init(dng_pthread_mutex_t *mutex, void * );
...
int dng_pthread_cond_init(dng_pthread_cond_t *cond, void * );
