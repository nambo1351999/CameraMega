...
import com.zoomx.mega.cameramega.ui.components.ImageHistogram
import com.zoomx.mega.cameramega.viewmodel.LutEditViewModel
        ...
        Column(
            ...
            ColorRecipePanel(
                ...
                onCurveChange = { channel, points ->
                    onParamsUpdated(
                        when (channel) {
                            com.zoomx.mega.cameramega.ui.components.CurveChannel.MASTER ->
                                editingParams.copy(masterCurvePoints = points)
                            com.zoomx.mega.cameramega.ui.components.CurveChannel.RED ->
                                editingParams.copy(redCurvePoints = points)
                            com.zoomx.mega.cameramega.ui.components.CurveChannel.GREEN ->
                                editingParams.copy(greenCurvePoints = points)
                            com.zoomx.mega.cameramega.ui.components.CurveChannel.BLUE ->
