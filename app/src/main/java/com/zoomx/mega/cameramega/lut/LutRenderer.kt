...
import com.zoomx.mega.cameramega.livephoto.resolveLivePhotoRotationDegrees
...
class LutRenderer(context: Context) : GLSurfaceView.Renderer {
    ...
    @Volatile
    var baselineRecipeParams: com.zoomx.mega.cameramega.model.ColorRecipeParams =
        com.zoomx.mega.cameramega.model.ColorRecipeParams.DEFAULT
    ...
    private fun getColorPassLocations(
        ...
        lutConfig: LutConfig?,
        lutEnabled: Boolean,
        params: com.zoomx.mega.cameramega.model.ColorRecipeParams,
    ...
    private fun drawInternal(
        ...
        val layerParams = when {
            ...
            else -> com.zoomx.mega.cameramega.model.ColorRecipeParams.DEFAULT
        }
    ...
    private fun getCurrentRecipeParams(): com.zoomx.mega.cameramega.model.ColorRecipeParams {
        return com.zoomx.mega.cameramega.model.ColorRecipeParams(
    ...
    fun setRecipeParams(params: com.zoomx.mega.cameramega.model.ColorRecipeParams) {
    ...
    fun updateBaselineRecipeParams(params: com.zoomx.mega.cameramega.model.ColorRecipeParams) {
