...
import com.zoomx.mega.cameramega.raw.DngBaselineExposure
...
import com.zoomx.mega.cameramega.raw.RawNoiseProfileLayout
import com.zoomx.mega.cameramega.raw.RawDemosaicProcessor
import com.zoomx.mega.cameramega.raw.RawRenderingEngine
import com.zoomx.mega.cameramega.raw.RawSceneExposureDeviceLimits
import com.zoomx.mega.cameramega.raw.RawWhiteLevelCorrection
import com.zoomx.mega.cameramega.raw.toAdobeDefaultMeteringPlan
import java.io.File
...
object RawProcessor {
    ...
    suspend fun prepareRawDngProfile(
        ...
        val captureProfile = options.captureProfilePreparer?.prepare(
            com.zoomx.mega.cameramega.raw.RawDngCaptureProfileInput(
        ...
        val exposureOffsetEv = captureProfile?.exposureOffsetEv
            ?.takeIf { it.isFinite() }
            ?.coerceIn(
                com.zoomx.mega.cameramega.raw.MeteringSystem.RAW_EXPOSURE_MIN_EV,
                com.zoomx.mega.cameramega.raw.MeteringSystem.RAW_EXPOSURE_MAX_EV,
            )
