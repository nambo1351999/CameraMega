...
import com.zoomx.mega.cameramega.lut.creator.LutCreatorScreen
import com.zoomx.mega.cameramega.lut.creator.LutCreatorViewModel
import com.zoomx.mega.cameramega.ml.StartupMlPreloader
import com.zoomx.mega.cameramega.screencapture.ScreenCaptureRenderConfigStore
import com.zoomx.mega.cameramega.ui.camera.CameraScreen
import com.zoomx.mega.cameramega.data.FilmData
import com.zoomx.mega.cameramega.ui.camera.ColorWalkScreen
import com.zoomx.mega.cameramega.ui.camera.FilmDetailScreen
import com.zoomx.mega.cameramega.ui.camera.FilmLibraryScreen
import com.zoomx.mega.cameramega.ui.camera.ToolboxScreen
import com.zoomx.mega.cameramega.ui.camera.PuzzleScreen
import com.zoomx.mega.cameramega.ui.gallery.BurstDetailScreen
import com.zoomx.mega.cameramega.ui.gallery.GalleryDetailScreen
import com.zoomx.mega.cameramega.ui.gallery.GalleryScreen
import com.zoomx.mega.cameramega.ui.gallery.GalleryEditScreen
import com.zoomx.mega.cameramega.ui.settings.FilterManagementScreen
import com.zoomx.mega.cameramega.ui.settings.FrameEditorScreen
import com.zoomx.mega.cameramega.ui.settings.FrameManagementScreen
import com.zoomx.mega.cameramega.ui.settings.PhantomPipCropScreen
...
import com.zoomx.mega.cameramega.viewmodel.GalleryTab
    ...
    Box(modifier = Modifier.fillMaxSize()) {
        NavHost(
            ...
            composable(Routes.LUT_SYNTHESIS) {
                com.zoomx.mega.cameramega.lut.synthesis.LutSynthesisScreen(
                    onNavigateBack = {
                        cameraViewModel.refreshCustomContent()
                        navController.popBackStack()
                    }
