package com.mega.filter.camera
...
import com.mega.filter.camera.lut.creator.LutCreatorScreen
import com.mega.filter.camera.lut.creator.LutCreatorViewModel
import com.mega.filter.camera.ml.StartupMlPreloader
import com.mega.filter.camera.screencapture.ScreenCaptureRenderConfigStore
import com.mega.filter.camera.ui.camera.CameraScreen
import com.mega.filter.camera.data.FilmData
import com.mega.filter.camera.ui.camera.ColorWalkScreen
import com.mega.filter.camera.ui.camera.FilmDetailScreen
import com.mega.filter.camera.ui.camera.FilmLibraryScreen
import com.mega.filter.camera.ui.camera.ToolboxScreen
import com.mega.filter.camera.ui.camera.PuzzleScreen
import com.mega.filter.camera.ui.gallery.BurstDetailScreen
import com.mega.filter.camera.ui.gallery.GalleryDetailScreen
import com.mega.filter.camera.ui.gallery.GalleryScreen
import com.mega.filter.camera.ui.gallery.GalleryEditScreen
import com.mega.filter.camera.ui.settings.FilterManagementScreen
import com.mega.filter.camera.ui.settings.FrameEditorScreen
import com.mega.filter.camera.ui.settings.FrameManagementScreen
import com.mega.filter.camera.ui.settings.PhantomPipCropScreen
import com.mega.filter.camera.ui.settings.SettingsScreen
import com.mega.filter.camera.ui.settings.PresetEditorScreen
import com.mega.filter.camera.ui.settings.PresetManagementScreen
import com.mega.filter.camera.data.UserPreferencesRepository
import com.mega.filter.camera.ui.flow.HomeMode
import com.mega.filter.camera.ui.flow.HomeScreen
import com.mega.filter.camera.ui.flow.LanguageOnboardingScreen
import com.mega.filter.camera.ui.flow.OnboardingScreen
import com.mega.filter.camera.ui.flow.SplashScreen
import com.mega.filter.camera.ui.theme.CameraMegaTheme
import androidx.compose.runtime.CompositionLocalProvider
import com.mega.filter.camera.ui.flow.CmFlowColors
import com.mega.filter.camera.ui.flow.CmFlowTypography
import com.mega.filter.camera.ui.flow.LocalCmFlowColors
import com.mega.filter.camera.ui.flow.LocalCmFlowTypography
import com.mega.filter.camera.update.AppUpdateManager
import com.mega.filter.camera.utils.BuglyHelper
...
import com.mega.filter.camera.viewmodel.GalleryTab
    ...
    Box(modifier = Modifier.fillMaxSize()) {
        NavHost(
            ...
            composable(Routes.LUT_SYNTHESIS) {
                com.mega.filter.camera.lut.synthesis.LutSynthesisScreen(
                    onNavigateBack = {
                        cameraViewModel.refreshCustomContent()
                        navController.popBackStack()
                    }
