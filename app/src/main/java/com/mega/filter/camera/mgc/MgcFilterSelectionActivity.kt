...
import com.mega.filter.camera.lut.sortLutsByUserOrder
import com.mega.filter.camera.ui.camera.LutEditBottomSheet
import com.mega.filter.camera.ui.components.LutEditButton
...
class MgcFilterSelectionActivity : ComponentActivity() {
    ...
    companion object {
        const val ACTION_SELECT_MGC_LOOK =
            "com.mega.filter.camera.action.SELECT_MGC_LOOK"
