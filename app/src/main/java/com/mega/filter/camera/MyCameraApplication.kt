...
import com.mega.filter.camera.phantom.PhantomService
import com.mega.filter.camera.phantom.PhantomShortcutActivity
...
class MyCameraApplication : Application() {
    ...
    companion object {
        ...
        fun updateWidgets(context: Context) {
            ...
            val componentName =
                android.content.ComponentName(context, com.mega.filter.camera.phantom.PhantomWidgetProvider::class.java)
            val appWidgetIds = appWidgetManager.getAppWidgetIds(componentName)
            if (appWidgetIds.isNotEmpty()) {
                val intent = Intent(context, com.mega.filter.camera.phantom.PhantomWidgetProvider::class.java).apply {
