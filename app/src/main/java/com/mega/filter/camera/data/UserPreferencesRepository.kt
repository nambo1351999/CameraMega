...
import com.mega.filter.camera.video.VIDEO_AUDIO_INPUT_AUTO
...
data class UserPreferences(
    ...
    val videoStabilizationMode: com.mega.filter.camera.video.VideoStabilizationMode = com.mega.filter.camera.video.VideoStabilizationMode.OIS,
    val videoTorchEnabled: Boolean = false,
    val videoLensLockEnabled: Boolean = false,
    val videoWhiteBalanceLockEnabled: Boolean = false,
    val videoCodec: com.mega.filter.camera.video.VideoCodec = com.mega.filter.camera.video.VideoCodec.H264,
...
class UserPreferencesRepository(private val context: Context) {
    ...
    val userPreferences: Flow<UserPreferences> = context.dataStore.data
        .map { preferences ->
            ...
            UserPreferences(
                ...
                videoStabilizationMode = com.mega.filter.camera.video.VideoStabilizationMode.valueOf(
                    preferences[VIDEO_STABILIZATION_MODE] ?: com.mega.filter.camera.video.VideoStabilizationMode.OIS.name
                ),
                ...
                videoCodec = com.mega.filter.camera.video.VideoCodec.valueOf(
                    preferences[VIDEO_CODEC] ?: com.mega.filter.camera.video.VideoCodec.H264.name
                ),
    ...
    suspend fun saveVideoStabilizationMode(mode: com.mega.filter.camera.video.VideoStabilizationMode) {
        context.dataStore.edit { preferences ->
    ...
    suspend fun saveVideoCodec(codec: com.mega.filter.camera.video.VideoCodec) {
        context.dataStore.edit { preferences ->
