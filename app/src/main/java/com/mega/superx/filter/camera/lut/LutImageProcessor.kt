...
import com.mega.superx.filter.camera.lut.ChromaDenoiseShaders
...
import com.mega.superx.filter.camera.raw.DenoiseProfileNlmConfig
import com.mega.superx.filter.camera.raw.DenoiseProfileShaders
...
import com.mega.superx.filter.camera.raw.RawSharpenPass
...
class LutImageProcessor(context: Context? = null) {
    ...
    private fun renderNaturalLightHncsOutput(
        ...
        val outputTransform = RawToneMappingGl.computeWorkingToOutputTransform(
            com.mega.superx.filter.camera.raw.ColorSpace.HNCS,
            com.mega.superx.filter.camera.raw.ColorSpace.SRGB,
        )
