...
import com.mega.superx.filter.camera.ui.components.ImageHistogram
import com.mega.superx.filter.camera.viewmodel.LutEditViewModel
        ...
        Column(
            ...
            ColorRecipePanel(
                ...
                onCurveChange = { channel, points ->
                    onParamsUpdated(
                        when (channel) {
                            com.mega.superx.filter.camera.ui.components.CurveChannel.MASTER ->
                                editingParams.copy(masterCurvePoints = points)
                            com.mega.superx.filter.camera.ui.components.CurveChannel.RED ->
                                editingParams.copy(redCurvePoints = points)
                            com.mega.superx.filter.camera.ui.components.CurveChannel.GREEN ->
                                editingParams.copy(greenCurvePoints = points)
                            com.mega.superx.filter.camera.ui.components.CurveChannel.BLUE ->
